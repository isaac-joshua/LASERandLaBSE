...
def assess():
    ...
    revision_file_path = r"./SmallData27/tam-tam2017.txt"
    reference_file_path = r"./SmallData27/eng-eng-kjv2006.txt"
...
output = assess()
if output:
    save_results_to_file(output["results"], "./LABsE/Outputs/tamilenglish.txt")
